export function TitleBar() {
  return (
    <div className="flex items-center justify-between h-[30px] bg-vscode-titlebar text-muted-foreground text-[13px] select-none border-b border-border font-sans shrink-0">
      ...
      <div className="text-center flex-1 font-mono text-[13px]">
